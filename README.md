...
A quick-start React app that shows how to add annotations to nodes and connectors in the Syncfusion&reg; React Diagram component. Also see how to customize the annotations using properties like horizontal alignment, vertical alignment, and offset.
